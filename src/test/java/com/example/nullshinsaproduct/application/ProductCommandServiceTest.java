...
import com.example.nullshinsaproduct.domain.dto.request.ProductOptionSaveRequest;
...
class ProductCommandServiceTest {
    ...
    void 상품등록() {
        ...
        Seller requestSeller = Seller.builder()
                .name("seller")
                .sellerPhoneNumber("010-1111-2222")
                .build();
        ...
        //when
        when(sellerRepository.findById(1L)).thenReturn(Optional.of(requestSeller));
